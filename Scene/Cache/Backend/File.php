 ...
 *  $frontCache = \Scene\Cache\Frontend\Output($frontendOptions);
 *
 ...
 *  $cache = new \Scene\Cache\Backend\File($frontCache, $backendOptions);
 *
...
class File extends Backend implements BackendInterface
{
    ...
    /**
     * \Scene\Cache\Backend\File constructor
     *

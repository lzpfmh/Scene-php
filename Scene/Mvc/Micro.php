...
use \Scene\Di\FactoryDefault;
use \Scene\Mvc\Micro\Exception;
use \Scene\Mvc\Micro\MiddlewareInterface;
use \Scene\Mvc\Micro\Collection;
use \Scene\Mvc\Micro\CollectionInterface;
use \Scene\Mvc\Micro\LazyLoader;
...
class Micro extends Injectable implements  \ArrayAccess
{
    ...
    */
     ...
     * Router
     *
     * @var null|\Scene\Mvc\RouterInterface
     * @access protected
    */
    protected $_router;
    ...
    */
     ...
     * Alias for \Scene\Mvc\Micro::hasService()
     *
     * @param string $alias
     * @return boolean
     */
     ...
     * Alias for \Scene\Mvc\Micro::setService()
     *
     *<code>
     *  $app['request'] = new \Scene\Http\Request();
     *</code>
     *
     * @param string $alias
     * @param mixed $definition
     ...
     * Alias for \Scene\Mvc\Micro::getService()
     *
     *<code>
     *  var_dump($di['request']);
     *</code>
